      ...
      appBar: AppBar(
        ...
        title: Row(
          children: [
            GestureDetector(
              onTap: (){
                Get.toNamed(Routes.GUEST, arguments: controller.chat.value.user);
              },
              child: Container(
            ...
            Column(
              children: [
                Text(controller.chat.value.user.name),
                Text(controller.chat.value.user.lastSeen),
              ],
            ),
          ],
        ),
                ...
                suffixIcon: IconButton(
                  ...
                  onPressed: () {
                    if(controller.text.value.isNotEmpty) {
                      ...
                      Message message = new Message(text: controller.text.value);
