...
class SearchView extends GetView<SearchController> {
  ...
  Widget buildSearchBar({bool heroTag = true, Function onSubmit}) {
            ...
            Expanded(
              child: Material(
                ...
                child: TextField(
                  ...
                  onSubmitted: (value) {
                    onSubmit == null? controller.searchEServices(keywords: value): onSubmit(keywords: value);
                  },
                  autofocus: true,
    ...
    return heroTag ? Hero(tag: Get.arguments, child: search) : search;
  }
}
